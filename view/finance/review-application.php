...
<?php require_once(ROOT.'/view/layout/menu.php');?>
     <?else:?>
<?php require_once(ROOT.'/view/layout/menu-all.php');?>
         <?endif;?>
</div>
</div><!--END NAVIDATION-->
...
<div class="table-container">
	<table>
			...
			<tbody>
	            ...
	            <tr>
				<td><a href="/finance-view-travel/<?php echo  $travel['id_travel'];?>"><?php echo  $travel['status'] == 1? '<span class="approved"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>approved</span>':'<span class="notapproved"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i>not approved</span>';?></a> / <?php echo $travel['name'];?></td>
