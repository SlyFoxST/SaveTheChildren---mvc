...
<div class="table-container">
	<table>
			...
			<tbody>
	            ...
	            <tr>
				<td><a href="/finance-my-travel/<?php echo  $travel['id_travel'];?>"><?php echo  $travel['status'] == 1? '<span class="approved"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>approved</span>':'<span class="notapproved"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i>not approved</span>';?></a></td>
