...
<div class="col-md-3 col-lg-3 col-sm-12">
	<div class="row">
<?php  include(ROOT.'/view/layout/menu-c.php');?>
</div>
</div><!--END NAVIDATION-->
<div class="col-md-9 col-lg-9 col-sm-12">
	...
	<div class="col-md-6">
			...
			<div class="section-nav"><i class="fa fa-eye" aria-hidden="true"></i>
				<br /><a href="/country-view-profile/">View Profile</a>
			</div>
		</div>
</div>
		<div class="col-md-6">
...
<br />
				<a href="/country-add-trip/">Add a trip</a>
			</div>
		</div>
</div>
		...
		<div class="col-md-6">
			...
			<div class="section-nav">
				...
				<br /><a href="/country-edit-profile/">Edit profile</a>
			</div>
		</div>
	</div>
		<div class="col-md-6">
<div class="row">
			...
			<br /><a href="/country-review-application/">Review of applications</a>
		</div>
	</div>
</div>
</div>
