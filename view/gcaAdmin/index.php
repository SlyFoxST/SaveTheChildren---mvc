...
<body class="bg-admin">
	<div class="wrapper-admin">
		...
		<div class="col-md-5 col-sm-5">
			...
			<a href="/gca-admin/"> <img src="/template/img/logo.png" class="img-responsive"/></a>
		</div>
		</div>
...
<div class="col-md-3 col-lg-3 col-sm-12">
	<div class="row">
<?php  include(ROOT.'/view/layout/menu-gca-admin.php');?>
</div>
</div><!--END NAVIDATION-->
<div class="col-md-9 col-lg-9 col-sm-12">
	...
	<div class="col-md-6">
			...
			<div class="section-nav"><i class="fa fa-eye" aria-hidden="true"></i>
				<br /><a href="/gca-admin-view-profile/">View Profile</a>
			</div>
		</div>
</div>
		<div class="col-md-6">
...
<br />
				<a href="/gca-admin-add-trip/">Add a trip</a>
			</div>
		</div>
</div>
		...
		<div class="col-md-6">
			...
			<div class="section-nav">
				...
				<br /><a href="/gca-admin-edit-profile/">Edit profile</a>
			</div>
		</div>
	</div>
		<div class="col-md-6">
<div class="row">
			...
			<br /><a href="/gca-admin-review-application/">Review of applications</a>
		</div>
	</div>
</div>
</div>
